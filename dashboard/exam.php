...
<html>
	<head>
		...
		<style type="text/css">
			...
			#step1, #step2 , #step3  { font-weight: bold}
		</style>
	...
	<body>
			...
			<ul class="nav menu">
				...
				<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
					...
					<ul class="children collapse" id="sub-item-1">
						...
						<li><a class="active" href="exam.php">
							Exam Registration
						</a></li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Exam Register</li>
				</ol>
			</div><!--/.row-->
			
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Exam Register</h1>
				</div>
			</div><!--/.row-->
				...
				<div class="col-md-6">
					<div class="panel panel-default ">
						...
						<div class="panel-body">
							...
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div class="alert" id="step2" role="alert" align="center">Select the subject and click on Register</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div class="alert" id="step3" role="alert" align="center">Date Validation</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div align="center"><span class="glyphicon" style="font-size:40px;">&#xe233;</span></div>
		...
		<script>
			window.onload = function () {
                	...
                	xhttp.onreadystatechange = function()
                	{
                    	...
                    	{                            
	                        ...
	                        {	
                                ...
                                xhttp.open('POST', 'ExamUpdate.php', true);
				...
				function validDate()
				{
					data = JSON.stringify({"variables" : {"status" : {"value": "valid"}	}});
					nextStep();
				...
				{
					data = JSON.stringify({"variables" : {"status" : {"value": "invalid"}	}});
					nextStep();
					document.getElementById("dateValidation").style.display = "none";
					document.getElementById("nextStep").disabled = false;
				}
				...
				{	
					...
					else if (processName == 'Check the confirmation on min page' || processName == 'Date is expired')
					{						
