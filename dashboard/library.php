...
<html>
	<head>
		...
		<style type="text/css">
			...
			#step1, #step2 , #step3 ,#step4, #step5,#step6  { font-weight: bold}
		</style>
	...
	<body>
			...
			<ul class="nav menu">
				...
				<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
					...
					<ul class="children collapse" id="sub-item-1">
						...
						<li><a class="active" href="library.php">
							Library
						</a></li>
					</ul>
				</li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Library book issue</li>
				</ol>
			</div><!--/.row-->
			
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Library book issue</h1>
				</div>
			</div><!--/.row-->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="panel panel-default ">
						...
						<div class="panel-body">
							...
							<div class="alert" id="step1" role="alert" align="center">Login to University portal</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div class="alert" id="step2" role="alert" align="center">Search the desired book under Search box</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div class="alert" id="step3" role="alert" align="center">Select any book with status 'Available'</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div class="alert" id="step4" role="alert" align="center">Issue the book on logged in id</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div class="alert" id="step5" role="alert" align="center">Use the book for specified time</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
                            <div class="alert" id="step6" role="alert" align="center">Returned Within Time?</div>
							<div align="center"><span class="glyphicon" >&#xe094;</span></div>
							<div align="center"><span class="glyphicon" style="font-size:40px;">&#xe233;</span></div>
				...
				<div class="col-md-6">
					...
					<div class="panel panel-default" id="dateValidation" style="display: none;">
						<div class="panel-heading">
							Are you Within the TimeFrame?
							<span class="pull-right clickable panel-toggle panel-button-tab-left"><em class="fa fa-toggle-up"></em></span>
						</div>
						<div class="panel-body timeline-container" align="center">
							<button id="validDate" class="btn btn-lg btn-primary" style="font-weight: bold">Yes !</button> 
							<button id="invalidDate" class="btn btn-lg btn-primary" style="font-weight: bold">No :(</button>
						</div>
					</div>
				</div><!--/.col-->
				<div class="col-sm-12">
		...
		<script>
			window.onload = function () {
		    	...
		    	document.getElementById("validDate").addEventListener('click', validDate);
		    	document.getElementById("invalidDate").addEventListener('click', invalidDate);
		    	getCurrStatus();
		    	...
		    	function startPro()
		    	{
	                ...
	                xhttp.open('POST', 'http://145.14.157.100:8080/engine-rest/process-definition/key/Library/start', true);
				...
				function getCurrStatus()
				{
                	...
                	xhttp.onreadystatechange = function()
                	{
                    	...
                    	{                            
	                        ...
	                        {	
                                ...
                                xhttp.open('POST', 'LibraryUpdate.php', true);
                	...
                	xhttp.open('GET', 'http://145.14.157.100:8080/engine-rest/task?processDefinitionKey=Library', true);
                	xhttp.send();
				}
				...
				function validDate()
				{
					data = JSON.stringify({"variables" : {"status" : {"value": "nofine"}	}});
					nextStep();
				...
				{
					data = JSON.stringify({"variables" : {"status" : {"value": "fine"}	}});
					nextStep();
					document.getElementById("dateValidation").style.display = "none";
					document.getElementById("nextStep").disabled = false;
				}
				...
				{	
					...
					else if (processName == 'Return the book' || processName == 'Pay the desired fine')
					{						
